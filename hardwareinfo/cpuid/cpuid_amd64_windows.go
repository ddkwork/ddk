...
func leaf0x80000006() {
	...
	associativityEncodings := map[uint]uint{
		0x00: 0,
		0x01: 1,
		0x02: 2,
		0x04: 4,
...
var leaf02Descriptors = map[int16]CacheDescriptor{
	...
	0x03: {-1, TLB, "MetaData TLB", 4, 4, -1, 64, 0},
	0x04: {-1, TLB, "MetaData TLB", 4 * 1024, 4, -1, 8, 0},
	0x05: {-1, TLB, "MetaData TLB1", 4 * 1024, 4, -1, 32, 0},
	...
	0x56:            {-1, TLB, "MetaData TLB0", 4 * 1024, 4, -1, 16, 0},
	0x57:            {-1, TLB, "MetaData TLB0", 4, 4, -1, 16, 0},
	0x59:            {-1, TLB, "MetaData TLB0", 4, 0xFF, -1, 16, 0},
	0x5A:            {-1, TLB, "MetaData TLB0 2-MByte or 4 MByte pages", 2 * 1024, 4, -1, 32, 0},
	0x5B:            {-1, TLB, "MetaData TLB 4 KByte and 4 MByte pages", 4, -1, -1, 64, 0},
	0x5C:            {-1, TLB, "MetaData TLB 4 KByte and 4 MByte pages", 4, -1, -1, 128, 0},
	0x5D:            {-1, TLB, "MetaData TLB 4 KByte and 4 MByte pages", 4, -1, -1, 256, 0},
	0x60:            {1, DATA_CACHE, "1st-level data cache", 16, 8, 64, -1, 0},
	0x61:            {-1, TLB, "Instruction TLB", 4, 0xFF, -1, 48, 0},
	0x63:            {-1, TLB, "MetaData TLB", 1 * 1024 * 1024, 4, -1, 4, 0},
	...
	0xB3: {-1, TLB, "MetaData TLB", 4, 4, -1, 128, 0},
	0xB4: {-1, TLB, "MetaData TLB1", 4, 4, -1, 256, 0},
	0xB5: {-1, TLB, "Instruction TLB", 4, 8, -1, 64, 0},
	0xB6: {-1, TLB, "Instruction TLB", 4, 8, -1, 128, 0},
	0xBA: {-1, TLB, "MetaData TLB1", 4, 4, -1, 64, 0},
	0xC0: {-1, TLB, "MetaData TLB: 4 KByte and 4 MByte pages", 4, 4, -1, 8, 0},
	...
	0xFF: {
		-1, NULL, "CPUID leaf 2 does not report cache descriptor " +
